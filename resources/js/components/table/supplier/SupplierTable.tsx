...
const SupplierTable = () => {
    ...
    return (
        <>
            ...
            {/* Modal */}
            <CRUDModal state={detailsModal} type='read' formData={formData} onClose={() => setDetailsModal(false)} selectedData={selectedData} />
            <CRUDModal state={postModal} type='create' formData={formData} onClose={() => setPostModal(false)} formInputChange={formInputChange} selectedData={selectedData} />
            <CRUDModal state={updateModal} type='update' formData={formData} onClose={() => setUpdateModal(false)} formInputChange={formInputChange} selectedData={selectedData} />
            <CRUDModal state={deleteModal} type='delete' onClose={() => setDeleteModal(false)} selectedData={selectedData} />
        </>
    )
}
